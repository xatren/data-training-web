      ...
      case "beginner":
        return (
          <div className="mb-8 p-4 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
            <h3 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Beginner Recommendations:</h3>
            <ul className="list-disc list-inside text-blue-700 dark:text-blue-300 space-y-1">
              <li>Start with small, clean datasets</li>
              <li>Use basic model configurations</li>
              <li>Focus on understanding the fundamentals</li>
              <li>Consider using our guided training mode</li>
            </ul>
          </div>
        );
      case "intermediate":
        return (
          <div className="mb-8 p-4 bg-green-50 dark:bg-green-900/30 rounded-lg">
            <h3 className="font-semibold text-green-800 dark:text-green-200 mb-2">Intermediate Recommendations:</h3>
            <ul className="list-disc list-inside text-green-700 dark:text-green-300 space-y-1">
              ...
              <li>Try advanced preprocessing techniques</li>
              <li>Explore hyperparameter tuning</li>
              <li>Consider using cross-validation</li>
            </ul>
          </div>
        );
      case "advanced":
        return (
          <div className="mb-8 p-4 bg-purple-50 dark:bg-purple-900/30 rounded-lg">
            <h3 className="font-semibold text-purple-800 dark:text-purple-200 mb-2">Advanced Recommendations:</h3>
            <ul className="list-disc list-inside text-purple-700 dark:text-purple-300 space-y-1">
              <li>Access to all advanced features</li>
              <li>Custom model architectures available</li>
              <li>Advanced optimization techniques</li>
              <li>Full control over training parameters</li>
            </ul>
          </div>
        );
      default:
      ...
      >
        <div className="max-w-3xl mx-auto">
          <div className="bg-white dark:bg-dark-100 rounded-xl shadow-lg p-8">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Train Your Model</h1>
